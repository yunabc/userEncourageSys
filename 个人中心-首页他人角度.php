                    ...
                    <div>
                        ...
                        <div class="user-intro-con">
                            <cite class="user-des fn-clear">
                                ...
                                <i class="user-sex female" style="display:none"></i>
                                <i class="user-sex man"></i>
                            </cite>
                            <a href="javascript:;" class="user-intr">一句话介绍下自己吧！</a>
                            <div class="fn-clear gz-sx-con">
                                <a href="javascript:;" class="gz-icon">关注</a>
                                <a href="javascript:;" class="sx-icon">私信</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div  class="col-md-9">
                <div id="main" class="pag-hor-20 tab-box">
                     <div class="trends-nav fn-clear tab-tit">
                        <a href="javascript:;" class="on" >他的WIKI<i></i></a>
                        <a href="javascript:;">他的动态<i></i></a>
                    </div>
                    <div class="tab-con">
                        <!--他的WIKI 开始-->
                        ...
                        <div class="my-trends-con" >
                            <ul class="my-trends-list">
                                <li>
                                    <p>
                                        <i>他</i>编辑了页面<a href="javascript:;">坦克指挥官页面</a>
            ...
            <div class="col-md-3 web-hide ">
                <div id="sidebar">
                    ...
                    <div class="fans-box fn-clear pag-hor-20">
                        <h3>他的关注<a href="javascript:;" class="fn-right" style="display:none">更多</a></h3>
                        <!--他没有粉丝、关注时  开始-->
                        <div class="no-fans">
                            <p><i></i>他还没有关注任何人</p>
                        </div>
                        <!--他没有粉丝、关注时  结束-->
                        <div class="row fans-con" style="display:none">
                    ...
                    <!--他的粉丝  开始-->
                    <div class="fans-box fn-clear pag-hor-20">
                        <h3>他的粉丝<a href="javascript:;" class="fn-right" style="display:none">更多</a></h3>
                        <!--他没有粉丝、关注时  开始-->
                        <div class="no-fans">
                            <p><i></i>他还没有关注任何人</p>
                        </div>
